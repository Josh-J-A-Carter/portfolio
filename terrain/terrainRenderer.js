...
// include: C:\Users\Joshua\AppData\Local\Temp\tmp5m4uye90.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'bin/terrainRenderer.data';
      var REMOTE_PACKAGE_BASE = 'terrainRenderer.data';
...
Module['FS_createPath']("/", "shaders", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_bin/terrainRenderer.data');

      };
      Module['addRunDependency']('datafile_bin/terrainRenderer.data');
    ...
    loadPackage({"files": [{"filename": "/shaders/default.fs", "start": 0, "end": 3352}, {"filename": "/shaders/default.vs", "start": 3352, "end": 6933}, {"filename": "/shaders/post.fs", "start": 6933, "end": 11405}, {"filename": "/shaders/post.vs", "start": 11405, "end": 14845}, {"filename": "/shaders/rng.fs", "start": 14845, "end": 21156}, {"filename": "/shaders/rng.vs", "start": 21156, "end": 24596}, {"filename": "/shaders/terrain.fs", "start": 24596, "end": 29431}, {"filename": "/shaders/terrain.vs", "start": 29431, "end": 34122}], "remote_package_size": 34122});

  })();

// end include: C:\Users\Joshua\AppData\Local\Temp\tmp5m4uye90.js
// include: C:\Users\Joshua\AppData\Local\Temp\tmpiwkkp7py.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if (Module['$ww'] || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: C:\Users\Joshua\AppData\Local\Temp\tmpiwkkp7py.js
// include: C:\Users\Joshua\AppData\Local\Temp\tmpr_keo4z1.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: C:\Users\Joshua\AppData\Local\Temp\tmpr_keo4z1.js
...
function findWasmBinary() {
  if (Module['locateFile']) {
    return locateFile('terrainRenderer.wasm');
  }
  // Use bundler-friendly `new URL(..., import.meta.url)` pattern; works in browsers too.
  return new URL('terrainRenderer.wasm', import.meta.url).href;
}
...
(() => {
  // Create a small, never-async wrapper around createTerrainRenderer which
  // checks for callers incorrectly using it with `new`.
  var real_createTerrainRenderer = createTerrainRenderer;
  createTerrainRenderer = function(arg) {
    if (new.target) throw new Error("createTerrainRenderer() should not be called with `new createTerrainRenderer()`");
    return real_createTerrainRenderer(arg);
  }
})();
